...
extern crate log;
#[macro_use]
extern crate arthur_hugon_tools;
#[macro_use]
...
use arthur_hugon_tools::security::{thread_rng, Rng};
use arthur_hugon_tools::simple_db::SimpleDB;
use arthur_hugon_tools::{is_env, set_var, var};
